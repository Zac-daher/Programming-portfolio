...
Each layer of the stack (web server, database, and model service) runs in a separate container. 

https://github.com/Zac-daher/Lamp_stack_cloud_computing

# 3. Orchestration Cloud Computing
A small Python based container orchestration project that has deployment of containers,
monitoring of health, and auto-scaling of container usage, behavior using Docker, Traefik, and custom logic.
This project focuses on understanding how orchestrators manage container load
and availability.

https://github.com/Zac-daher/Orchestration_cloudcomputing

# 4. Parallel Threading in C
A low-level systems programming project written in C that examines parallel
threading, synchronization, and performance tradeoffs. The project emphasizes
understanding how multithreaded programs behave at the system level.
